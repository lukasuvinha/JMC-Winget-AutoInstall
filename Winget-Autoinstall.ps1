...
#ping -n 3 https://github.com/SasaDermanovic/2024-Winget-Setup-Guide-Windows-10-LTSC/archive/refs/heads/main.zip
...
#ping -n 3 https://github.com/R-YaTian/LTSC-Add-MicrosoftStore-2021_2024/archive/refs/heads/main.zip
